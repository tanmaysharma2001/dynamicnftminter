...
def connect_contract(username):
    ...
    contract_address = '0xec26b987a72BCCe1C1Be987a37EdFa62d48bc1df'
...
def mint_token_(username):
    ...
    create_nft = nftMinter.functions.mint_nft().buildTransaction(
        {
            "chainId": trx_info['goerli_chain_id'],
    ...
    opensea_url = f"https://testnets.opensea.io/assets/goerli/{trx_info['contract_address']}/{token_id - 1}"
    return opensea_url
